		    ...
		    <table class="form_table">
				...
				<tr>
					<td class="center" colspan="4">
			        	<a class="button button-primary button-rounded button-small" onclick="upload_wx_qrcode('${basePath }agent_member/upload_wx_qrcode');">保存</a>
			        	<a class="button button-caution button-rounded button-small" onclick="del_wx_qrcode('${basePath }agent_member/del_wx_qrcode?id=${model.id}');">删除</a>
