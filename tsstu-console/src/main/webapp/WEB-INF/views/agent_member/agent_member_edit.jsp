    	...
    	<form id="form1">
		    ...
		    <table class="form_table">
				<tr>
					...
					<td class="right"><span class="must">*</span>代理会员名称：</td>
					<td><input type="text" name="name" id="name" value="${model.name }" maxlength="32" placeholder="这里输入代理会员名称" title="代理会员名称" style="width:98%;"/></td>
				</tr>
				<tr>
					<td class="right"><span class="must">*</span>公司名称：</td>
					<td><input type="text" name="company_name" id="company_name" value="${model.company_name }" maxlength="32" placeholder="这里输入公司名称" title="公司名称" style="width:98%;"/></td>
					<td class="right"><span class="must">*</span>公司负责人：</td>
					<td><input type="text" name="company_leader" id="company_leader" value="${model.company_leader }" maxlength="32" placeholder="这里输入公司负责人" title="公司负责人" style="width:98%;"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="identity" id="identity" value="${model.identity }" maxlength="32" placeholder="这里输入证件编号" title="证件编号" style="width:98%;"/></td>
					<td class="right"><span class="must">*</span>分红比例：</td>
					<td><input type="text" name="psition_percent" id="psition_percent" value="${model.psition_percent }" maxlength="32" placeholder="这里输入分红比例" title="分红比例" style="width:98%;"/></td>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	function save() {
		...
		if ($.trim($("#id").val())=="") {
			add("${basePath}agent_member/add");
		} else {
			edit("${basePath}agent_member/edit");
		}
	}
	...
	function inputCheck() {
		...
		if ($.trim($("#identity").val())=="" && $.trim($("#identity").val()) == "") {
			$("#identity").tips("请输入证件编号").focus();
			return;
		}
		if ($.trim($("#psition_percent").val())=="" && $.trim($("#psition_percent").val()) == "") {
			$("#psition_percent").tips("请输入分红比例").focus();
			return;
		}
