		    ...
		    <table class="form_table">
				...
				<tr>
					<td class="center" colspan="4">
			        	<a class="button button-primary button-rounded button-small" onclick="review('${bashPath}broker_apply/review', 1);">通过</a>
			        	<a class="button button-primary button-rounded button-small" onclick="review('${bashPath}broker_apply/review', 2);">驳回</a>
...
<script type="text/javascript">
	...
	function review(url, review_status) {
		...
		if ($.trim(review_remark) == "") {
			review_remark = review_status == 1 ? "经纪人申请审批通过！" : "经纪人申请请被驳回！";
		}
		var msg = review_status == 1 ? "确定要审批通过申请吗？" : "确定要驳回申请吗？";
