		    ...
		    <table class="form_table">
					...
					<td>
						<div class="vocation">
						    <select id="pay_method" name="pay_method" class="select3">
							    ...
							    <c:forEach items="${D_WITHDRAW_PAY_METHOD }" var="item" varStatus="status">
				...
				<tr>
					<td class="center" colspan="4">
			        	<a class="button button-primary button-rounded button-small" onclick="pay_pass('${bashPath}withdraw_order/pay');">付款</a>
			        	<a class="button button-primary button-rounded button-small" onclick="pay_reject('${bashPath}withdraw_order/pay');">驳回</a>
