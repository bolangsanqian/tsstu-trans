...
import com.tsstu.console.dao.WithdrawOrderMapper;
 ...
 */
@Service
public class WithdrawOrderServiceImpl extends BaseServiceImpl<WithdrawOrder> implements WithdrawOrderService {

    @Autowired
    private WithdrawOrderMapper withdrawOrderMapper;
    
    @Override
	public BaseMapper<WithdrawOrder> getDao() {
		return withdrawOrderMapper;
	}
    ...
    public int reviewPass(Integer id, Integer review_id, String review_remark) {
    	WithdrawOrder order = this.getOne(id);
    	if (null == order) {
