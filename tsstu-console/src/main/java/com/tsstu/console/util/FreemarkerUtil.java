...
public class FreemarkerUtil {
	 ...
	 *  @param ftlName
	 */
	public static String getString(String ftlName, Map<String,Object> root, String ftlPath) throws Exception{
		try {
			Template template = getTemplate(ftlName, ftlPath);		//通过Template可以将模板文件输出到相应的流
