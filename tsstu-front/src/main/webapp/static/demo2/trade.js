...
.controller('TradeCtrl', function($scope, $filter, $rootScope, $timeout, $interval, $stateParams, $echartsDelegate,$ionicModal, QouteService, OrderService, UserService, HistoryQouteService, CloseOrderService) {
